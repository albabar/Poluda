...
namespace {
	...
	class Cart extends \Moltin\Cart\Facade{
		 ...
		 */
		 public static function __construct($store, $identifier){
			//Method inherited from \Moltin\Cart\Cart
	...
	class Omnipay extends \Ignited\LaravelOmnipay\Facades\OmnipayFacade{
		 ...
		 */
		 public static function __construct($app, $factory){
			//Method inherited from \Ignited\LaravelOmnipay\LaravelOmnipayManager
			 \Ignited\LaravelOmnipay\LaravelOmnipayManager::__construct($app, $factory);
		 }
		 ...
		 */
		 public static function creditCard($cardInput){
			//Method inherited from \Ignited\LaravelOmnipay\LaravelOmnipayManager
			 \Ignited\LaravelOmnipay\LaravelOmnipayManager::creditCard($cardInput);
		 }
		 ...
		 */
		 public static function getGateway(){
			//Method inherited from \Ignited\LaravelOmnipay\LaravelOmnipayManager
			 \Ignited\LaravelOmnipay\LaravelOmnipayManager::getGateway();
		 }
		 ...
		 */
		 public static function setGateway($name){
			//Method inherited from \Ignited\LaravelOmnipay\LaravelOmnipayManager
			 \Ignited\LaravelOmnipay\LaravelOmnipayManager::setGateway($name);
		 }
		 ...
		 */
		 public static function __call($method, $parameters){
			//Method inherited from \Ignited\LaravelOmnipay\LaravelOmnipayManager
			 \Ignited\LaravelOmnipay\LaravelOmnipayManager::__call($method, $parameters);
		 }
